    ...
    <div className='min-h-screen bg-gray-50 flex items-center justify-center'>
      <div className={`flex flex-col items-center ${containerClasses[size]}`}>
        ...
        <div className='relative'>
          ...
          {/* Inner pulse dot */}
          <div 
            className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-2 h-2 bg-blue-500 rounded-full animate-pulse'
          />
        </div>
        
        {/* Loading message */}
        <div className={`${textClasses[size]} font-medium text-gray-700 animate-pulse`}>
          {message}
        </div>
